      ...
      <div className="space-y-6">
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {isLeader && (
              <Link to={`/events/${eventId}/tasks/new${departmentId ? `?departmentId=${departmentId}` : ''}`} className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">
                <Plus size={18} />
                Tạo task
              </Link>
            )}
